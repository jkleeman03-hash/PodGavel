    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-24 text-center">
        <h1 className="max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl">
          Looking to stress-test your ads across multiple target demos?
        </h1>
        <p className="mt-4 max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl">
          Does your budget get eaten by pre-determined ad CPM&apos;s?
        </p>
        <p className="mt-6 max-w-xl text-lg text-gray-600">
          With PodGavel, you can stretch your budget to reach more
          audiences and see more return on your advertisements.
        </p>
